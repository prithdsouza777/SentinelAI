    ...
    <div className="flex h-full flex-col gap-4 overflow-auto pr-1">
        ...
        {simulationActive && (
          ...
          >
            <div className="flex items-center gap-3 rounded-xl border border-[#f59e0b]/30 bg-[#f59e0b]/5 px-4 py-3">
              ...
              <span className="text-sm font-semibold text-[#f59e0b]">Simulation Active</span>
              ...
              <Button
                ...
                className="ml-auto h-7 bg-[#ef4444] text-[11px] font-semibold text-white hover:bg-[#dc2626]"
              >
      ...
      <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {scenario.featured && (
                      <span className="flex items-center gap-1 rounded bg-[#8b5cf6]/10 px-1.5 py-0.5 text-[9px] font-bold text-[#8b5cf6]">
                        <Sparkles className="h-2.5 w-2.5" />
                        RECOMMENDED
                      </span>
                    )}
                  </div>
                  <p className="text-[12px] text-[#64748b]">{scenario.description}</p>
        ...
        <div className="rounded-xl border border-[#e2e8f0] bg-white shadow-sm">
          ...
          <p className="px-3 pt-3 text-[12px] text-[#64748b]">
            ...
            {chaosActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className="flex w-full flex-col items-center gap-2 rounded-xl border border-[#e2e8f0] bg-[#f8fafc] p-4 text-center transition-all hover:border-[#2563eb]/30 hover:bg-white hover:shadow-sm disabled:opacity-50"
                >
                  ...
                  <span className="text-[10px] text-[#64748b]">{action.description}</span>
                  {chaosInjected === action.type && (
                    <span className="text-[10px] font-bold text-[#10b981]">Injected!</span>
                  )}
                </button>
              );
            })}
